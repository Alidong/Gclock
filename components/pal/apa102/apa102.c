...
void apa102_reset_pins(const apa102_t *apa102)
{
...
void apa102_send_colorfram(const apa102_t *apa102,uint16_t count, uint32_t* pColor)
{
    apa102_startFrame(apa102);
    for (uint16_t i =0;i<count;i++)
    {
        uint8_t brightness=(pColor[i]>>24) | 0b11100000;
        uint8_t blue= (pColor[i]>>16)&0xFF;
        uint8_t green=(pColor[i]>>8)&0xFF;
        uint8_t red=(pColor[i])&0xFF;
        apa102_transfer(apa102,brightness);
        apa102_transfer(apa102,blue);
        apa102_transfer(apa102,green);
        apa102_transfer(apa102,red);
    }
